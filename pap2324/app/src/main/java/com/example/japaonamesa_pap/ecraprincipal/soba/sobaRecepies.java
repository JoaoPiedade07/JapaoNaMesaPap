package com.example.japaonamesa_pap.ecraprincipal.soba;
...
public class sobaRecepies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soba_recepies);
